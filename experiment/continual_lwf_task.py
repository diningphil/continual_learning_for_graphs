...
class ContinualLwFTask(Experiment):
    """
    We assume a classification task
    """
    def __init__(self, model_configuration, exp_path):
        super(ContinualLwFTask, self).__init__(model_configuration, exp_path)
    ...
    def run_valid(self, dataset_getter, logger):
        ...
        for t in range(n_tasks):
            ...
            supervised_training_wrapper.state.update(prev_models=prev_models)
    ...
    def run_test(self, dataset_getter, logger):
        ...
        for t in range(n_tasks):
            ...
            train_loader = dataset_getter.get_outer_train(batch_size=1, shuffle=shuffle, task_id=t)
